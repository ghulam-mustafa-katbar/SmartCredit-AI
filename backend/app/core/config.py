...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql://postgres%2Emeiybbpcneynddjwzrcy:dJoVNBJbUPFm0FKd@aws-1-ap-northeast-2.pooler.supabase.com:5432/postgres")
